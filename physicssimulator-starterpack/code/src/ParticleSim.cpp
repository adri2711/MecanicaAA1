...
ParticleSim::ParticleSim() {
	...
	particleSystems[0]->emissionRate = 100.f;
	...
	particleSystems[1]->emissionRate = 00.f;
	...
	Sphere* sphere = new Sphere(glm::vec3(0.f, 5.f, 0.f), 1.f);	
	AddCollider(sphere);

	Capsule* capsule = new Capsule(glm::vec3(0.f, 1.f, 5.f), glm::vec3(0.f, 2.f, -5.f), 1.f);                        
	AddCollider(capsule);
